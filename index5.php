...
<body>
<a href="menambahkandata1.php">Add New User</a><br/><br/>
<center> <h2>DATA KEPEGAWAIAN</h2> </center>
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='edit4.php?employee_id=$user_data[employee_id]'>Edit</a> | <a href='hapus3.php?employee_id=$user_data[employee_id]'>Delete</a></td></tr>";        
    }
    ?>
    </table>
</body>
